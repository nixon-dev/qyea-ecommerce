...
<head>
    ...
    <title>Product List - QYEA Store</title>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img loading="lazy" height="100" width="100"
                                                            ...
                                                            src="assets/img/products/<?php echo $p['product_picture']; ?>">
                                                    </td>
                                                    <td><?php echo $p['product_name']; ?></td>
                                                    <td width="250px"><?php echo mb_strimwidth($p['product_description'], 0, 200, '...'); ?></td>
                                                    <td class="text-center">
                                                        <?php if ($p['product_stock'] >= $p['product_low_stock']): ?>
                                                            <span
                                                                class="label label-success"><?php echo $p['product_stock']; ?></span>
                                                        <?php else: ?>
                                                            <span
                                                                class="label label-danger"><?php echo $p['product_stock']; ?></span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td class="text-center"><?php echo number_format($p['product_sold']); ?></td>
                                                    <td class="text-right footable-visible footable-last-column">
                                                        <div class="btn-group">
                                                            <a class="btn-info btn btn-xs"
                                                                href="view-product?id=<?php echo $p['product_id']; ?>"><i
                                                                    class="fa-solid fa-pencil"></i> </a>&nbsp;
                                                            <a class="btn-danger btn btn-xs"
                                                                href="inc/delete_products?id=<?php echo $p['product_id']; ?>"><i
