...
<head>
    ...
    <title>Remove Product Stock - QYEA Store</title>
...
<body class="fixed-sidebar full-height-layout skin-2">
    ...
    if (empty($_GET['id'])) {
        ...
        include("inc/fetch_product_stock_details.php");
    }
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="view-product?id=<?php echo $product_id; ?>"><?php echo $productname; ?></a>
                        </li>
                        <li class="breadcrumb-item active">
                        ...
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <form method="POST" action="inc/update_product_stocks.php"
                                    ...
                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            <input type="number" placeholder="ID" id="product_id" name="product_id"
                                                class="form-control d-none" value="<?php echo $product_id; ?>" required>
                                        </div>
                                    </div>

                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            <input type="number" placeholder="ID" id="ps_id" name="ps_id"
                                    ...
                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            <input type="number" placeholder="Amount" id="amount" name="amount" max="<?php echo $ps_stock; ?>"
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea class="form-control" style="height: 100px"
                                                placeholder="Description" name="reason" required></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <div class="col-sm-12 d-flex justify-content-center">
                                            <button class="btn btn-primary btn-md" name="removeStockBtn"
