            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="rejected-orders">Rejected</a>
                        </li>
                    ...
                    <div class="col-lg-6">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <h3><strong>Order Status:</strong> Rejected </h3>
                                <h3><strong>Shipping Status:</strong> N/A </h3>
                                <h3><strong>Reason of Rejection:</strong> <?php echo $rejection; ?></h3>
                            </div>
