    ...
    <section id="about" class="container about">
        <div class="row">
            <div class="col-sm-12 ">
                ...
                <h4 style="white-space: pre-line; text-align: justify; text-justify: inter-word; text-indent: 20px;" >
                    <?php
                    ...
                    foreach ($paragraphs as $paragraph) {
                        $indentedText .= '<span style="text-indent: 30px; display: block; margin-bottom: 10px;">' . htmlspecialchars($paragraph) . '</span>';
                    }

                    echo "<p style='text-indent: 0; font-size: 15px;' class='text-dark'>" . $indentedText . "</p>";
                    ?>
