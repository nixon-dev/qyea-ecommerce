...
<head>
    ...
    <title>Add Users - QYEA Store</title>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <form method="POST" action="inc/insert_users.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <input type="password" placeholder="Password" id="password1"
                                                name="password1" class="form-control" minlength="8" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="password" placeholder="Confirm Password" id="password2"
                                                name="password2" class="form-control" minlength="8" required>
                                        </div>
                                    </div>
