...
<head>
    ...
    <title>Add Supplies - QYEA Store</title>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <form method="POST" action="inc/insert_supplies.php" enctype="multipart/form-data">


                                    <div class="form-group" style="padding-left: 15px; padding-right: 15px;">
                                        <div class="custom-file col-sm-12">
                                            <input name="suppliespicture" type="file" class="custom-file-input"
                                    ...
                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            <input type="text" placeholder="Supply Name" name="suppliesname"
                                    ...
                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            <input type="number" placeholder="Stock" name="suppliesstock"
                                                class="form-control" required>
                                        </div>
                                    </div>
